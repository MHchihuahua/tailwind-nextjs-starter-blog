...
const Header = () => {
  let headerClass =
    'flex items-center w-full bg-white dark:bg-neutral-900 justify-between py-10 transition-colors duration-300'
      ...
      <Link href="/" aria-label={siteMetadata.headerTitle}>
        <div className="flex items-center justify-between">
          ...
          {typeof siteMetadata.headerTitle === 'string' ? (
            <div className="flex hidden h-6 items-center text-2xl font-semibold sm:flex">
